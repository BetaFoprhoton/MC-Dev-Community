...
import com.intellij.openapi.diff.impl.dir.DirDiffPanel.MainPanel
...
class ChatMainPanel(val myProject: Project) {
    ...
    val button = JButton(LocaleUtil.message("MC-Dev-Community.Chat.Send"), getIcon("/icons/send.svg", ChatMainPanel::class.java))
    ...
    init {
        ...
        contentPanel.add(MessageComponent("Hello World!", true))
